...
ACLOCAL = ${SHELL} /grabber/phash/pHash-0.9.6/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /grabber/phash/pHash-0.9.6/missing --run autoconf
AUTOHEADER = ${SHELL} /grabber/phash/pHash-0.9.6/missing --run autoheader
AUTOMAKE = ${SHELL} /grabber/phash/pHash-0.9.6/missing --run automake-1.12
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS =  -O2 -ffast-math -O3
CPP = gcc -E
CPPFLAGS = -pthread -I/usr/local/include -I/usr/include/ffmpeg
CXX = g++
CXXCPP = g++ -E
...
LIBOBJS = 
LIBS = -lmpg123 -lsamplerate -lsndfile -lswscale -lavformat -lavutil -lavcodec  
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIBTOOLS_DEPS = 
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /grabber/phash/pHash-0.9.6/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.9.6
abs_builddir = /grabber/phash/pHash-0.9.6
abs_srcdir = /grabber/phash/pHash-0.9.6
abs_top_builddir = /grabber/phash/pHash-0.9.6
abs_top_srcdir = /grabber/phash/pHash-0.9.6
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /grabber/phash/pHash-0.9.6/install-sh
